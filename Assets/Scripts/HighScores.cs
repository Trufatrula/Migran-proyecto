...
public class HighScores : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AddNewScore("Pichulon", 4500);
        AddNewScore("Perro Sancho", 5520);
        AddNewScore("Los huevos de pascua", 380);
        AddNewScore("Del San Andreas", 6654);
        AddNewScore("ASDFGHJ", 11021);
        AddNewScore("tgg7", 3252);
        UpdateDisplay();
    }
    void UpdateDisplay()
    {
